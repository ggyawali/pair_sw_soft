...
PairStyle(sw/soft,PairSWSoft)

#else

#ifndef LMP_PAIR_SW_SOFT_H
#define LMP_PAIR_SW_SOFT_H

#include "pair.h"

namespace LAMMPS_NS {

class PairSWSoft : public Pair {
 public:
  PairSWSoft(class LAMMPS *);
  virtual ~PairSWSoft();
  ...
  double  **mu, mu_one,alpha, powern, type_solvent;
  int initialized;
